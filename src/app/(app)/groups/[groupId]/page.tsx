...
//       const isCurrentUserMember = currentGroup.members.some(
...
//           description:
//             "Please select at least one participant for the expense.",
//           variant: "destructive",
//         });
//         return;
//       }
...
//             title: "Expense Added",
//             description: `${
//               resultAction.payload.description
//             } of $${resultAction.payload.amount.toFixed(2)} added.`,
//           });
...
//       const userIsParticipant = expense.participants.some(
...
//                   src={
//                     member.avatarUrl ||
//                     `https://picsum.photos/seed/${member.username}/40/40`
//                   }
//                   alt={member.username}
...
//                 <DialogDescription>
//                   Enter details and select participants. Split is equal among
//                   selected members.
//                 </DialogDescription>
//               </DialogHeader>
//               <form onSubmit={handleAddExpense} className="grid gap-4 py-4">
//                 <div className="grid grid-cols-4 items-center gap-4">
//                   <Label htmlFor="exp-description" className="text-right">
//                     Description
//                   </Label>
//                   <Input
//                     id="exp-description"
...
//                 </div>
//                 <div className="grid grid-cols-4 items-center gap-4">
//                   <Label htmlFor="exp-amount" className="text-right">
//                     Amount ($)
//                   </Label>
//                   <Input
//                     id="exp-amount"
...
//                 </div>
//                 <div className="grid grid-cols-4 items-center gap-4">
//                   <Label htmlFor="exp-paidby" className="text-right">
//                     Paid by
//                   </Label>
...
//                 </div>
//                 <div className="grid grid-cols-4 items-center gap-4">
//                   <Label htmlFor="exp-category" className="text-right">
//                     Category
//                   </Label>
//                   <Select
...
//                             onCheckedChange={() =>
//                               handleParticipantSelection(member.id)
//                             }
//                           />
//                           <Label
...
//                                 src={
//                                   member.avatarUrl ||
//                                   `https://picsum.photos/seed/${member.username}/20/20`
//                                 }
//                                 alt={member.username}
//                                 data-ai-hint="person avatar"
//                               />
...
//                             `https://picsum.photos/seed/${expense.paidBy.username}/40/40`
//                           }
...
//                             src={
//                               p.avatarUrl ||
//                               `https://picsum.photos/seed/${p.username}/24/24`
//                             }
//                             alt={p.username}
//                             data-ai-hint="person avatar"
//                           />
...
//           <CardDescription>
//             Who owes whom in this group. (Simplified view, detailed calculations
//             needed for complex splits)
//           </CardDescription>
//         </CardHeader>
//         <CardContent>
//           <p className="text-muted-foreground">
//             Advanced settlement calculations based on custom splits will be
//             implemented later.
//           </p>
//           <Button className="mt-4" disabled>
//             <DollarSign className="mr-2 h-4 w-4" /> Settle Up Manually (Coming
//             Soon)
//           </Button>
//         </CardContent>
//       </Card>
