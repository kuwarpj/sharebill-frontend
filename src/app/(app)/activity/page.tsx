...
import { History, ListFilter, Download } from "lucide-react";
                ...
                <li key={activity.id} className="p-4 hover:bg-muted/50 transition-colors">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div className="flex items-center gap-3 mb-2 sm:mb-0">
                        ...
                        {activity.type === 'group_joined' && <Users className="h-5 w-5 text-green-500 flex-shrink-0" />}
                        {activity.type === 'settlement' && <DollarSign className="h-5 w-5 text-blue-500 flex-shrink-0" />}
                        <div>
...
// Placeholder for DollarSign if not in lucide-react, or use an alternative
